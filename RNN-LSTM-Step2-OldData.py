...
fopOutputTotal=fopRoot+'resultMLs/'
lstRoots=['rnn-lstm-small']
for root in lstRoots:
    fopOutputML=fopOutputTotal+root+'/'
    ...
    fpLabelP1Train = fopOutputML + 'train.label.p3.txt'

    # fpValid = fopRoot + 'valid.csv'
    # fpTextValid = fopRoot + 'testP.text.txt'
    fpLabelP1Valid = fopOutputML + 'testP.label.p3.txt'

    # fpTest = fopRoot + 'test.csv'
    # fpTextTest = fopRoot + 'testW.text.txt'
    fpLabelP1Test = fopOutputML + 'testW.label.p3.txt'
    ...
    print('{}\t{}\t{}\t{}\t{}\t{}\t{}'.format(root,precision,recall,fscore,acc,train_time_p1,test_time_p1))
    sys.stdout.close()
