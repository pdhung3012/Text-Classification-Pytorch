...
sys.stdout = open(fpResultDetails, 'w')
putTextAndLabelInRange(lstTuplesTrainTestValid,idxTrainStart,idxTrainEnd,fpLabelP1Train,fpLabelP2Train,fpLabelP3Train)
putTextAndLabelInRange(lstTuplesTrainTestValid,idxTestPStart,idxTestPEnd,fpLabelP1Valid,fpLabelP2Valid,fpLabelP3Valid)
putTextAndLabelInRange(lstTuplesTrainTestValid,idxTestWStart,idxTestWEnd,fpLabelP1Test,fpLabelP2Test,fpLabelP3Test)
