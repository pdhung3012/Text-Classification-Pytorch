...
acc_p1,train_time_p1,test_time_p1=trainAndEval(train_data,valid_data,test_data)
...
acc_p2,train_time_p2,test_time_p2=trainAndEval(train_data,valid_data,test_data)
...
acc_p3,train_time_p3,test_time_p3=trainAndEval(train_data,valid_data,test_data)
print('\n\nP1\t{}\t{}\t{}\nP2\t{}\t{}\t{}\nP3\t{}\t{}\t{}'.format(acc_p1,train_time_p1,test_time_p1,acc_p2,train_time_p2,test_time_p2,acc_p3,train_time_p3,test_time_p3))
sys.stdout.close()
