...
def train(model, iterator, optimizer, criterion):
    ...
    for batch in iterator:
        ...
        if(len(text)==0 or len(text_lengths)==0):
            print('damage')
            continue
        try:
...
fopOutputML=fopRoot+'step6_Incons/lstm/'
...
print('P1\t{}\t{}\t{}\t{}\t{}\t{}\t{}'.format(os.path.basename(fopOutputML),precision,recall,fscore,acc,train_time_p1,test_time_p1))
# sys.stdout.close()
